...
class __TwigTemplate_1c789d9e324ce7370dfaea90ec0a3f5c0feec8d83345bc4d99318366794783f5 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 3
        $context["deprecatedElements"] = twig_array_filter(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["project"] ?? null), "indexes", [], "any", false, false, false, 3), "elements", [], "any", false, false, false, 3), function ($__element__) use ($context, $macros) { $context["element"] = $__element__; return twig_get_attribute($this->env, $this->source, ($context["element"] ?? null), "deprecated", [], "any", false, false, false, 3); });
        // line 5
        $context["filesWithDeprecatedElements"] = twig_array_reduce(($context["deprecatedElements"] ?? null),         // line 6
...
";
    ...
    <div class=\"phpdocumentor-row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["file"]) {
            ...
            // line 42
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_array_filter(($context["deprecatedElements"] ?? null), function ($__el__) use ($context, $macros) { $context["el"] = $__el__; return (twig_get_attribute($this->env, $this->source, ($context["el"] ?? null), "file", [], "any", false, false, false, 42) == $context["file"]); }));
